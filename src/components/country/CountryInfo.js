...
import goldenKey from "../../lib/util/GoldenKey";
                    ...
                    <div className="modal-dialog">
                        <div className="modal-content">
                            ...
                            <div className="modal-footer">
                                <button type="button" className="btn btn-primary" onClick={() => onBankruptcy()} data-dismiss="modal">
                                    확인
                                </button>
                            </div>
                        </div>
                ...
                <div className="modal fade" id="Country_Event" role="dialog">
                    <div className="modal-dialog">
                        <div className="modal-content">
                            ...
                            <div className="modal-footer">
                                <button type="button" className="btn btn-primary" onClick={() => onEvent(event, random)} data-dismiss="modal">
                                    확인
                                </button>
                            </div>
                        </div>
                ...
                <div className="modal fade" id="Country_Buy" role="dialog">
                    <div className="modal-dialog">
                        <div className="modal-content">
                            ...
                            <div className="modal-footer">
                                <button type="button" className="btn btn-primary" onClick={() => this.handleBankruptcyOnBuy()} data-dismiss="modal">
                                    구매하기
                                </button>
                                <button type="button" className="btn btn-default" onClick={() => onBuy(false)} data-dismiss="modal">
                                    닫기
                                </button>
                            </div>
                        </div>
                ...
                <div className="modal fade" id="Country_Deal" role="dialog">
                    <div className="modal-dialog">
                        <div className="modal-content">
                            ...
                            <div className="modal-body">
                                <p>
                                    {owner}님의 땅을 밟았습니다({price}원).
                                </p>
                            </div>
                            <div className="modal-footer">
                                <button type="button" className="btn btn-primary" onClick={() => this.handleBankruptcyOnDeal()} data-dismiss="modal">
                                    지불하기
                                </button>
                                <button type="button" className="btn btn-default" onClick={() => onBankruptcy()} data-dismiss="modal">
                                    파산하기
                                </button>
                            </div>
                        </div>
